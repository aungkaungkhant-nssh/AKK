...
export const projectLists = [
    ...
    },
    {
        ...
        desc: "Toe Tet is an online education platform that offers a variety of on-demand courses, providing learners with the opportunity to enhance their knowledge and skills at their own pace. With a focus on accessibility and flexibility, Toe Tet allows students to learn anytime, anywhere. The platform features a wide range of subjects, making it an ideal resource for anyone looking to further their education or develop new skills. Whether for personal development or career advancement, Toe Tet is committed to empowering learners with valuable educational resources.",
        logo: ToeTet.src,
        githubLink: null,
